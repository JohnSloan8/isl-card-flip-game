    ...
    <Container align="center" maxWidth="xs" sx={{ padding: "0" }}>
      ...
      <Grid container spacing={2} mt={2}>
        <Grid item xs={4}>
          <img
            width="100%"
            src="/assets/images/drawn-alphabet-images/isl-drawn-i.png"
          />
        ...
        <Grid item xs={4}>
          <img
            width="100%"
            src="/assets/images/drawn-alphabet-images/isl-drawn-s.png"
          />
        ...
        <Grid item xs={4}>
          <img
            width="100%"
            src="/assets/images/drawn-alphabet-images/isl-drawn-l.png"
          />
      ...
      <Box mt={2}>
        <Typography variant="body1" align="left">
          Let's take a look at the whole alphabet.
        </Typography>
      </Box>
