...
const GameGrid = () => {
  ...
  let genieImageURL = "/assets/images/genie.png"
  let lampImageURL = "/assets/images/lamp.png"
  ...
  const shakeLamp = () => {
    ...
    shakeTween.to(lampRef.current, {x: 3, y: 5, duration: 0.025})
    shakeTween.to(lampRef.current, {x: -3, y: -5, duration: 0.05})
  ...
  const genieAppear = () => {
    ...
    genieAppearTween.fromTo(genieRef.current, {scale: 0, y:'25%', x:'5%'}, {scale: 5, y: '0%', x:'0%'})
  }
